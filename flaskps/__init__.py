...
from flaskps.resources import admin, auth, user, estudiante, docente, taller, ciclo_lectivo, instrumento, mapa, asistencia
...
#asistencia
app.add_url_rule('/asistencia/asistencia', 'asistencia', asistencia.asistencia)
app.add_url_rule('/asistencia/cargarAsistenciaHoy', 'cargarAsistenciaHoy', asistencia.cargarAsistenciaHoy, methods=['GET', 'POST'])
app.add_url_rule('/asistencia/modificarAsistencia', 'modificarAsistencia', asistencia.modificarAsistencia)
app.add_url_rule('/asistencia/mostrarAsistencia', 'mostrarAsistencia', asistencia.mostrarAsistencia)
